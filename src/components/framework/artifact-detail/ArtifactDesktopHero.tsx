  ...
  return (
    ...
    >
      ...
      <span className="inline-flex items-center gap-1.5">
        <Youtube className="h-4 w-4 shrink-0 text-red-500" aria-hidden />
        YouTube
      </span>
  ...
  return (
    <div className="flex flex-wrap items-center gap-2.5">
      <Button
        ...
        size="lg"
        className={cn(
          "h-11 gap-2 rounded-full px-6 text-sm font-semibold",
      ...
      <Button
        ...
        variant="outline"
        className={cn(
          "h-11 gap-2 rounded-full px-5 text-sm font-medium",
    ...
    return (
      ...
      >
        ...
        <div className="space-y-4 px-5 py-5 sm:px-6 sm:py-6">
          ...
          <h1 className="max-w-4xl font-display text-2xl font-normal leading-[1.15] tracking-tight text-foreground sm:text-[2rem] lg:text-[2.35rem]">
            {displayTitle}
          </h1>
