...
export function retryJournalVideoUpload(userId: string, entryId: string, id: string): boolean {
  ...
  updateQueuedJournalVideoUpload(id, { stage: "queued", lastAttemptAt: undefined, lastError: undefined });
