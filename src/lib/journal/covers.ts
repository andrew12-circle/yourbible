...
export function journalCoverFocal(
  journal: Partial<Pick<{ cover_focal_x?: number; cover_focal_y?: number }, "cover_focal_x" | "cover_focal_y">>,
): { x: number; y: number } {
  return {
...
export function journalCoverObjectPosition(
  journal: Partial<Pick<{ cover_focal_x?: number; cover_focal_y?: number }, "cover_focal_x" | "cover_focal_y">>,
): string {
