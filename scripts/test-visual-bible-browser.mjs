...
try {
  ...
  record("Artist search and artifact category filtering in the real reader shell");
  ...
  record("Phone-width collection has no horizontal overflow");
  ...
  assert(await detail.getByText(/not evidence for a particular census/).isVisible());
